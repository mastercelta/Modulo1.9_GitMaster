 ...
 */
class Cenpos_Simplewebpay_SimplewebpayController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Retrieve Simplewebpay helper
     *
     * @return Cenpos_Simplewebpay_Helper_Data
     */
    ...
    public function checkemailAction()
    {
        try {
            ...
            if (empty($response)) {
                Mage::throwException('Error: Connection to simplewebpay.com failed');
            }
